...
def normalize_rotated_pdf(input_pdf_path, output_pdf_path):
    """
    Creates a new PDF where pages with rotation metadata are normalized to upright.
    Returns True if any rotation was changed, otherwise False.
    """
...
def get_best_pdf_for_extraction(pdf_path):
    """
    If the PDF has rotated pages, generate a normalized upright copy and use it.
...
async def upload_pdf(file: UploadFile = File(...)):
    ...
    # normalize rotated/sideways PDF pages before extraction
